...
// search for "MAX_WORDS_SAMPLE"

// var beginWord = "foo"
// var endWord = "bar"
// var wordList = []string{"boo", "bro", "brr", "bar"}

var beginWord string = SAMPLE_INPUT.beginWord
var endWord string = SAMPLE_INPUT.endWord
var wordList []string = SAMPLE_INPUT.wordList

var SAMPLE_INPUT = // swap in any of the predefined inputs below
// TEST_CASE_1        //
// TEST_CASE_2 //
// TEST_CASE_3 //
// TEST_CASE_4        //
...
/** Expected Output: [["a", "c"]] */
var TEST_CASE_2 = Inputs{
	beginWord: "a",
	endWord:   "c",
	wordList:  []string{"a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "w", "x", "y", "z"}}

/** Test Case 3: No Possible Transformation */
/** Expected Output: [] */
var TEST_CASE_3 = Inputs{
	beginWord: "hit",
	endWord:   "cog",
...
var TEST_CASE_4 = Inputs{
	beginWord: "lame",
	endWord:   "same",
	wordList:  []string{"same", "came", "lame", "name"}}

/** Test Case 5: Transformation with Repeated Characters */
/** Expected Output: [["aaaa", "aaab", "aabb", "abbb", "bbbb"]] */
var TEST_CASE_5 = Inputs{
	beginWord: "aaaa",
	endWord:   "bbbb",
	wordList:  []string{"aaaa", "abbb", "aaab", "aabb", "bbbb"}}
...
var EMAIL_EXAMPLE = Inputs{
	beginWord: "cig",
	endWord:   "cot",
	wordList:  []string{"cot", "dog", "cat", "cut", "mug", "fog", "fig", "mut", "dug"}}

/** README Example 1, same Test Case 1 above */
/** expected result: [[hit hot dot dog cog] [hit hot lot log cog]] */
var README_EXAMPLE_1 = Inputs{
	beginWord: "hit",
	endWord:   "cog",
	wordList:  []string{"hot", "dot", "dog", "lot", "log", "cog"}}
...
var README_EXAMPLE_2 = Inputs{
	beginWord: "lost",
	endWord:   "cost",
	wordList:  []string{"most", "fost", "cost", "host", "lost"}}

/** README Example 3 */
/** expected result: [] */
var README_EXAMPLE_3 = Inputs{
	beginWord: "start",
	endWord:   "endit",
...
var MAX_WORDS_SAMPLE = Inputs{
	...
	wordList: []string{
		...
		"zzzzz", // added endWord, since I now understand it's required to be in the list
	},
}
